...
const RegistrationModel = ({ adminId, onClose }) => {
  const [formData, setFormData] = useState({
    ...
    // ✅ UPDATED: supervisor is now an ID
    supervisor_id: '',

    // UI-only field (NOT DB direct column anymore)
    skills: '',
  ...
  // --- SHA-256 Hashing (kept, though backend also hashes) ---
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { skills, ...cleanData } = formData;
      ...
      if (result.status === 'success') {
        setStatus({
          type: 'success',
          msg: `Personnel ID ${result.user_id} registered.`
        });
        ...
        <form onSubmit={handleSubmit} className="reg-form">
          ...
          <div className="form-section">
            ...
            <div className="input-grid">
              ...
              <input
                name="supervisor_id"
                placeholder="Supervisor ID (e.g. user_1234)"
